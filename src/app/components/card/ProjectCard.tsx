...
export function ProjectCard(props: ProjectCardProps) {
  return (
    <>
      <div className="flex justify-between items-center group/project cursor-pointer">
        <div className="flex items-center overflow-hidden relative">
          <div className="transition-all group-hover/project:left-0 flex -left-12 absolute items-center justify-center w-12 h-12 rounded-full bg-primary-container text-primary-on-container">
            {props.number}
          </div>
          <div className="transition-all max-w-sm group-hover/project:ml-16">
            <h2 className="text-base-content-100 font-bold text-3xl mb-3">
              {props.title}
            </h2>
            <p className="text-base-content-100 font-light">
              {props.description}
            </p>
          </div>
        </div>
        <div className="flex items-center gap-12">
          ...
          <Link
            href={props.url}
            className="transition-all bg-primary-container border border-secondary relative w-[60px] h-[60px] rounded-3xl group/view-project hover:w-[114px]"
          >
            <svg
